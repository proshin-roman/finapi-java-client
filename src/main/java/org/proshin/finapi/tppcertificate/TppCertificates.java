...
public interface TppCertificates {
    ...
    TppCertificate one(Long id);

    Page<TppCertificate> query(QueryTppCertificatesCriteria criteria);

    TppCertificate create(CreateTppCertificateParameters parameters);
}
