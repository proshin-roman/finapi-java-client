...
public final class HighTransactionAmountParams implements NotificationRuleParams {
    ...
    public HighTransactionAmountParams(final BigDecimal absoluteAmountThreshold) {
        this.origin = new JSONObject()
            .put("absoluteAmountThreshold", absoluteAmountThreshold);
    }

    public HighTransactionAmountParams withAccounts(final Iterable<Long> accounts) {
        this.origin.put("accountIds", new StringOf(accounts));
        return this;
    }

    public HighTransactionAmountParams withMaxTransactionsCount(final int maxTransactionsCount) {
