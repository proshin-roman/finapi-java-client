...
public final class ForeignMoneyTransferParams implements NotificationRuleParams {

    private final JSONObject origin;

    public ForeignMoneyTransferParams(final Iterable<Long> accounts) {
    ...
    public boolean support(final TriggerEvent triggerEvent) {
        return triggerEvent == TriggerEvent.FOREIGN_MONEY_TRANSFER;
    }
