        ...
        this.server()
            .when(
                HttpRequest.request("/api/v1/transactions")
                    ...
                    .withQueryStringParameter("counterpart", "just%20counterpart")
                    .withQueryStringParameter("purpose", "just%20purpose")
                    .withQueryStringParameter("accountIds", "3,4,5")
                    ...
                    .withQueryStringParameter("labelIds", "4,5,6")
                    .withQueryStringParameter("categoryIds", "5,6,7")
                    ...
                    .withQueryStringParameter("order", "id,desc", "date,asc")
            )
            .respond(HttpResponse.response('{' +
                "  \"transactions\": [{}]," +
                "  \"paging\": {" +
